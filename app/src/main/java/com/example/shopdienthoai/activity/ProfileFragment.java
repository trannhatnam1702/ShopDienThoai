...
public class ProfileFragment extends Fragment {
    ...
    LinearLayout btnLogout, linearTrackOrder, linearAllOrders;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnLogout = view.findViewById(R.id.linearLogOut);
        ...
        constraintLayout = view.findViewById(R.id.constraintProfile);
        ...
        linearAllOrders = view.findViewById(R.id.linearAllOrders);
        linearAllOrders.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
